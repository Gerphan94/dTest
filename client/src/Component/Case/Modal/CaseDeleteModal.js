...
function CaseDeleteModal( { setCaseDelModal, caseDelModal, fetchCaseData, sectionId }) {
    ...
    const handleSubmit = async () => {
        try {
            const response = await fetch(urlAPI + 'api/mark-as-deleted-case/' + caseDelModal.caseId, {
                method: 'POST',
                headers: {
                    ...
                    <div >
                        ...
                        <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                            ...
                            <div className="relative p-6 text-left text-sm">
                                <div>
                                    Are you want delete <strong>{caseDelModal && caseDelModal.caseTitle}</strong> ? 
                                </div>
